...
enum Lang {
  ...
  GladiatorOfFinale_TwoPieceSet = 'GladiatorOfFinaleFinale_TwoPieceSet',
  ...
  GladiatorOfFinale_FourPieceSet = 'GladiatorOfFinaleFinale_FourPieceSet',
  ...
  Character_Ascension_Material = 'Character_Ascension_Material',
  ...
  Saturday = 'Saturday',
  Sunday = 'Sunday',
  Weekly_Boss_Items = 'Weekly_Boss_Items',
  ...
  Field_Monster_Drop_Item = 'Field_Monster_Drop_Item',
  Local_Speciality_Items = 'Local_Speciality_Items',
  ...
  Ranged_Hilichurls = 'Ranged_Hilichurls',
  Slimes = 'Slimes',
  Treasure_Hoarders = 'Treasure_Hoarders',
  Fatui_Skirmishers = 'Fatui_Skirmishers',
  Electro_Hypostasis = 'Electro_Hypostasis',
  Anemo_Hypostasis = 'Anemo_Hypostasis',
  Cryo_Regisvines = 'Cryo_Regisvines',
  Oceanid = 'Oceanid',
  Geo_Hypostasis = 'Geo_Hypostasis',
  Pyro_Regisvines = 'Pyro_Regisvines',
  Mist_Grass_Pollen = 'Mist_Grass_Pollen',
  Dead_Ley_Line_Branch = 'Dead_Ley_Line_Branch',
  Chaos_Device = 'Chaos_Device',
  Heavy_Horn = 'Heavy_Horn',
  Hunters_Sacrificial_Knife = 'Hunters_Sacrificial_Knife',
  Fragile_Bone_Shard = 'Fragile_Bone_Shard',
  Electro_Cicin_Mages = 'Electro_Cicin_Mages',
  Abyss_Mages = 'Abyss_Mages',
  Ruin_Guards = 'Ruin_Guards',
  Ruin_Hunters = 'Ruin_Hunters',
